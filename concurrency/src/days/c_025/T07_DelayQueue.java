...
public class T07_DelayQueue {
    ...
    static class MyTask implements Delayed {
        ...
        public String toString(){return ""+runningTime;}
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        MyTask t3= new MyTask(now+3000);//创建任务，表示该任务1.5s之后可以被消费
        MyTask t4= new MyTask(now+4000);//创建任务，表示该任务2.5s之后可以被消费
        MyTask t5= new MyTask(now+5000);//创建任务，表示该任务0.5s之后可以被消费
